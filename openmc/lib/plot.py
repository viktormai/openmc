...
def compute_surface_crossings():
    _dll.openmc_compute_surface_crossings()
    return slice_surface_crossing_data()
...
_dll.openmc_compute_surface_crossings.argtypes = []
_dll.openmc_compute_surface_crossings.restype  = c_int
_dll.openmc_compute_surface_crossings.errcheck = _error_handler
